...
teamup_url = f'https://api.teamup.com/ksjvi17ce1ipimpco8/events?startDate={today_str}&endDate={today_str}&tz=Asia/Jakarta'
...
try:
    tulis_hari_dan_tanggal(worksheet, today)
...
try:
    ...
    pdf_file_name = f"agenda_{today_str}.pdf"
...
try:
    asyncio.run(send_telegram_message_and_file(pdf_file_name, bot_token, chat_id, today_str))
except Exception as e:
